...
import { Edit3, Plus, ScanLine, Trash2 } from '@lucide/vue';
import { ref } from 'vue';
...
const props = defineProps<{ products: { data: Product[] }; categories: Category[]; catalogueMode: 'shared' | 'separate_online' }>();
        ...
        <div class="mx-auto flex min-h-screen max-w-[1600px]">
            ...
            <section class="min-w-0 flex-1 px-4 py-6 sm:px-8 sm:py-10">
                ...
                <div class="mx-auto max-w-7xl space-y-8">
                    ...
                    <EnCard>
                        <div v-if="props.products.data.length" class="overflow-x-auto">
